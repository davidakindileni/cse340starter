-- QUERY 1: Create the Type 'Enumeration' in Render
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO cse340akin;
...
-- QUERY 2: Table structure for table 'inventory'
...
-- QUERY 3: Create relationship between 'classification' and 'inventory' tables
...
-- QUERY 4: Table structure for table `account`
...
-- QUERIES FOR SQL STATEMENTS PRACTICE - Assignment 2 Task One
